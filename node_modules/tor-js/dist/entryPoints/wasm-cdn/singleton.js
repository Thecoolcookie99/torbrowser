  ...
  if (cache) {
    try {
      ...
      if (cached) {
        ...
        if (hash === "952bf7f4efcd5b4e97be0e3a9f0dd93e16003891ca90600e0bac7eaa407faecb") {
          return bytes;
        }
  ...
  for (const source of sources) {
    for (const url of source.urls) {
      try {
        ...
        const hash = await sha256hex(bytes);
        if (hash !== "952bf7f4efcd5b4e97be0e3a9f0dd93e16003891ca90600e0bac7eaa407faecb") {
          throw new Error(`SHA256 mismatch: expected ${"952bf7f4efcd5b4e97be0e3a9f0dd93e16003891ca90600e0bac7eaa407faecb"}, got ${hash}`);
        }
