...
var init_wasm_cdn = __esm({
  "../node_modules/tor-js/dist/entryPoints/wasm-cdn/index.js"() {
    ...
    __esm2 = /* @__PURE__ */ __name((fn, res) => /* @__PURE__ */ __name(function __init() {
    ...
    IntoUnderlyingByteSource = /* @__PURE__ */ __name(class {
      __destroy_into_raw() {
    ...
    IntoUnderlyingSink = /* @__PURE__ */ __name(class {
      __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
    ...
    IntoUnderlyingSource = /* @__PURE__ */ __name(class _IntoUnderlyingSource {
      static __wrap(ptr) {
    ...
    TorClient = /* @__PURE__ */ __name(class _TorClient {
      static __wrap(ptr) {
    ...
    TorClientOptions = /* @__PURE__ */ __name(class _TorClientOptions {
      static __wrap(ptr) {
    ...
    MemoryStorage = /* @__PURE__ */ __name(class {
    ...
    IndexedDBStorage = /* @__PURE__ */ __name(class {
      dbName;
      storeName = "keyvalue";
      dbPromise = null;
    ...
    FilesystemStorage = /* @__PURE__ */ __name(class _FilesystemStorage {
      dirPath;
      name;
    ...
    Log = /* @__PURE__ */ __name(class _Log {
      rawLog;
      parentStartTime;
      namePrefix;
      constructor(params = {}) {
    ...
    KpsGateway = /* @__PURE__ */ __name(class {
      #address;
      #certhash;
      #connPromise = null;
...
`));
    ...
    ArtiSocket = /* @__PURE__ */ __name(class _ArtiSocket {
    ...
    ArtiSocketProvider = /* @__PURE__ */ __name(class {
      #states = [];
      #strategies;
      #timing;
      constructor(options = {}) {
    ...
    TorClient2 = /* @__PURE__ */ __name(class {
      log;
      clientPromise;
...
var ONION_HOST_RE, SCHEME_RE, SKIP_URL_RE, URL_ATTRIBUTES;
...
var DEFAULT_MAX_RESPONSE_BYTES, DEFAULT_FETCH_TIMEOUT_MS, sharedTorStorage, CloudflareArtiSocketProvider;
var init_tor = __esm({
  "../src/lib/tor.ts"() {
    "use strict";
    init_functionsRoutes_0_5509863109313802();
    ...
    CloudflareArtiSocketProvider = class {
      get gateway() {
        return null;
      }
      async connect(target) {
...
var INDEX_PATHS, VIEWER_METHODS, onRequest;
var init_path = __esm({
  "[[path]].ts"() {
    "use strict";
    init_functionsRoutes_0_5509863109313802();
    ...
    onRequest = /* @__PURE__ */ __name(async (context2) => {
      const request = context2.request;
...
// ../.wrangler/tmp/bundle-xugThh/middleware-loader.entry.ts
init_functionsRoutes_0_5509863109313802();
init_strip_cf_connecting_ip_header();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// ../.wrangler/tmp/bundle-xugThh/middleware-insertion-facade.js
init_functionsRoutes_0_5509863109313802();
init_strip_cf_connecting_ip_header();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
//# sourceMappingURL=functionsWorker-0.5693531564327259.mjs.map
