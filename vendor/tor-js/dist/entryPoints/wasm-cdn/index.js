...
// src/entryPoints/wasm-cdn/index.ts
var CACHE_KEY = "wasm";
  ...
  if (cache) {
    try {
      ...
      if (cached) {
        ...
        if (hash === "8279f40f3efa514ba9efe446ec9e18fb1ba02953c8af4884f2c6823700f2f82f") {
          return bytes;
        }
  ...
  for (const source of sources) {
    for (const url of source.urls) {
      try {
        ...
        const hash = await sha256hex(bytes);
        if (hash !== "8279f40f3efa514ba9efe446ec9e18fb1ba02953c8af4884f2c6823700f2f82f") {
          throw new Error(`SHA256 mismatch: expected ${"8279f40f3efa514ba9efe446ec9e18fb1ba02953c8af4884f2c6823700f2f82f"}, got ${hash}`);
        }
