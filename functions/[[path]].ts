import { fetchThroughTor, type TorFetchEnv } from '../src/lib/tor.js';
import { isOnionHostname, normalizeTargetUrl, parseViewerTarget, resolveLoadUrl } from '../src/lib/route.js';
